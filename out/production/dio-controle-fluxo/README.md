...
O sistema receberá como parâmetros dois números inteiros via terminal. Com estes dois números você deverá obter a 
quantidade de iterações(for) e realizar a impressão no console(System.out.print) dos números incrementados, exemplo:

* Se você passar os números 12 e 30, logo teremos uma iteração (for) com 18 ocorrências para imprimir os números, 
